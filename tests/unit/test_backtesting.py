...
from radarx.backtesting import BacktestEngine, StrategySimulator, OutcomeLabeler, LearningLedger
...
class TestBacktestEngine:
    ...
    def test_initialization(self):
        ...
        engine = BacktestEngine(train_window_days=90, test_window_days=30, step_days=7)
    ...
    def test_simulate_trading(self):
        ...
        result = engine.simulate_trading(predictions, actual_returns, threshold=0.5, capital=10000)
...
class TestStrategySimulator:
    ...
    def test_initialization(self):
        ...
        sim = StrategySimulator(initial_capital=10000, trading_fee=0.003, slippage_factor=0.001)
    ...
    def test_threshold_strategy(self):
        ...
        predictions = {"token1": {"heatmap": {"7d": {"10x": 0.2}}}}
...
class TestOutcomeLabeler:
    ...
    def test_initialization(self):
        ...
        labeler = OutcomeLabeler(
            multipliers=["2x", "5x", "10x"], horizons=["24h", "7d"], min_liquidity_usd=50000
        )
    ...
    def test_label_outcomes(self):
        ...
        labeler = OutcomeLabeler(
            multipliers=["2x", "5x"], horizons=["24h"], min_liquidity_usd=10000, min_volume_24h=1000
        )
    ...
    def test_label_quality_metrics(self):
        ...
        labeler = OutcomeLabeler(multipliers=["2x"], horizons=["24h"])
    ...
    def test_to_training_format(self):
        ...
        features = {"token1": {"feature1": 1.0, "feature2": 2.0}}
...
class TestLearningLedger:
    ...
    def test_log_model_version(self):
        ...
        version_id = ledger.log_model_version(
            model=model, version="v1.0.0", config={"param1": "value1"}, notes="Test model"
        )
    ...
    def test_log_backtest_result(self):
        ...
        version_id = ledger.log_model_version(model=DummyModel(), version="v1.0.0", config={})
