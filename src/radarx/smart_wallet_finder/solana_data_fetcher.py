...
class SolanaDataFetcher(DataFetcher):
    ...
    def _fetch_token_metadata(
        ...
        loop = asyncio.get_event_loop()
        return loop.run_until_complete(self._fetch_solana_token_metadata_async(token_address))
    ...
    def _fetch_graph_neighbors(
        ...
        loop = asyncio.get_event_loop()
        return loop.run_until_complete(self._fetch_solana_graph_neighbors_async(wallet_address))
