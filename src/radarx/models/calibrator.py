...
class CalibrationPipeline:
    ...
    def __init__(
        self, method: Literal["isotonic", "platt"] = "isotonic", model_dir: Optional[Path] = None
    ):
        """
    ...
    def evaluate_calibration(self, y_true: dict, y_pred: dict) -> dict:
        ...
        for key in y_true:
            ...
            metrics[key] = {"ece": float(ece), "brier_score": float(brier)}
    ...
    def save(self, path: Optional[Path] = None):
        ...
        # Save metadata
        metadata = {"method": self.method, "is_fitted": self.is_fitted}
