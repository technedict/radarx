...
class ExplainerModel:
    ...
    def fit(self, model, X_background: np.ndarray, feature_names: List[str],
    ...
    def explain(self, X: np.ndarray, model_key: str = "default",
                top_n: int = 5) -> Dict:
        """
    ...
    def _get_feature_description(self, feature_name: str, value: float, 
